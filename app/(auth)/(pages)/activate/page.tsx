...
export default function Page() {
  ...
  const validate = () => {
    if (isValid) return <p className="text-lg text-gray-500">¡Cuenta activada exitosamente!</p>;
    if (!isValid) return <p className="text-lg text-gray-500">Error al activar tu cuenta, token invalido.</p>;
  };

  return (
    <section className="flex h-screen items-start bg-white px-6 py-12" id="login">
      <Toaster />
